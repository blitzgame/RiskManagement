...
module.exports = cds.service.impl(async function () 
{
    ...
    */
    ...
    {
        // This API Sandbox returns alot of business partners with empty names.
        // WE dont;t want them in our application

        req.query.where("LastName <> '' nad FirstName <> '' ");
    ...
    //---------------I really dont understnad this part---------------
    /**
    ...
    this.on("READ", Risks, async (req, next) => {
        ...
        */
        try 
        {
            ...
            await Promise.all( es.map (async (risk) => 
            {
